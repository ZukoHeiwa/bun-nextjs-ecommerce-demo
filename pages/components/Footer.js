...
const Footer = () => {
  ...
  return (
    <>
        <div className="px-4 divide-y bg-white text-black">
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© {currentYear} Company Co. All rights reserved.</div>
</div>
    </>
  )
}
